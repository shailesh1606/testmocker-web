...
export const PdfCanvasViewer = forwardRef<PdfCanvasViewerRef, PdfCanvasViewerProps>(
  ({ pdfId, zoom }, ref) => {
    ...
    return (
      <div className="pdf-panel-outer relative w-full h-full min-h-0 overflow-hidden bg-slate-100">
        <div
          ref={scrollContainerRef}
          className="pdf-panel-scroll w-full h-full min-h-0 overflow-y-auto overflow-x-auto flex flex-col items-center py-6 gap-6"
          style={{
